...
<!-- test end  -->
                    ...
                    <div  id="contact-form" >
                      ...
                      <form:form method="post" action="somepage" commandName="somedata">
                       <div class="col-md-12 form-group">
                                ...
                                <input type="text" name="sourcename" class="form-control" id="sourcename" placeholder="Source Name"  />
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="email" class="form-control" name="validate_header_footer_flag" id="validate_header_footer_flag" placeholder="Your Email"  />
 ...
 logging attribute start
						...
						<button type="submit" style="height: 40px; margin-bottom: 50px;" class="col-md-offset-4 col-md-4 btn btn-primary">ADD Source</button>
